...
public class ClaimRxDataFromHCI3_H extends ClaimRxAbstract implements ClaimRxInterface {
	 ...
	 * @param errMgr
	 */
	public ClaimRxDataFromHCI3_H (ErrorManager errMgr) {
		this.errMgr = errMgr;
	...
	//private static org.apache.log4j.Logger log = Logger.getLogger(ClaimRxDataFromHCI3_H.class);
