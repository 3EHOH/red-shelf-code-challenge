...
select 'Step: SQL-costRollups-unsplit-filter1.sql' as curstep, current_timestamp as datetime;
\set AUTOCOMMIT on


/* ScriptName:costRollups-unsplit-filter1.sql    */
...
) AS sa ON mel.master_episode_id = sa.uber_master_episode_id
AND mel.level = 2
AND mel.split = 0
AND mel.annualized = 0
AND mel.filter_id = 1
