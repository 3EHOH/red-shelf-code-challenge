...
public class EnrollmentDataFromWellpoint extends EnrollmentDataAbstract implements EnrollmentDataInterface {
	 ...
	 * @param errMgr
	 */
	public EnrollmentDataFromWellpoint (ErrorManager errMgr) {
		this.errMgr = errMgr;
	 ...
	 */
	public EnrollmentDataFromWellpoint () {
		this.errMgr = null;
		super.sDelimiter = this.sDelimiter;
		//seedLastEndDt();
	}
	...
	public static void main(String[] args) {
		bDebug = true;
		EnrollmentDataFromWellpoint instance = new EnrollmentDataFromWellpoint();
		try {
