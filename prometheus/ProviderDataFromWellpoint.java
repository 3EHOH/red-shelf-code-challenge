...
public class ProviderDataFromWellpoint extends ProviderDataAbstract implements ProviderDataInterface  {
	 ...
	 * @param errMgr
	 */
	public ProviderDataFromWellpoint(ErrorManager errMgr) {
		this.errMgr = errMgr;
	 ...
	 */
	public ProviderDataFromWellpoint () {
		this.errMgr = null;
		super.sDelimiter = this.sDelimiter;
	}
	...
	*/
	...
	public static void main(String[] args) {
		bDebug = true;
		ProviderDataFromWellpoint instance = new ProviderDataFromWellpoint();
		try {
	...
	private static org.apache.log4j.Logger log = Logger.getLogger(ProviderDataFromWellpoint.class);
