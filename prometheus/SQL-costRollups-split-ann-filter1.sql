...
select 'Step: SQL-costRollups-split-ann-filter1.sql' as curstep, current_timestamp as datetime;
\set AUTOCOMMIT on
...
/* ScriptName:costRollups-split-ann-filter1.sql    */
