...
#############################################
#           Applies all filters             #
#     including the coverage gap filter     #
#############################################
...
and (age_limit_lower + age_limit_upper + episode_cost_lower + episode_cost_upper + episode_complete + coverage_gap + drg + proc_ep_orphan + proc_ep_orph_triggered)>=1
...
and (age_limit_lower + age_limit_upper + episode_cost_upper + episode_complete + coverage_gap + drg + proc_ep_orphan + proc_ep_orph_triggered)>=1
AND ra_episode_data.epi_id=filtered_episodes.master_episode_id);
