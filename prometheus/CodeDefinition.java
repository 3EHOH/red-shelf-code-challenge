...
public class CodeDefinition implements Serializable {
	...
	/*
    private EpisodeToCodeDefinition episodetocodedefinition;
    
	@ManyToOne(cascade=CascadeType.ALL)  
	public EpisodeToCodeDefinition getEpisodetocodedefinition()  {
		return episodetocodedefinition;  
	}
	public void setEpisodetocodedefinition(EpisodeToCodeDefinition episodetocodedefinition)  {
		this.episodetocodedefinition = episodetocodedefinition;  
	} 
	*/
